	...
	$('button#askbtn').click(function(event) {
		...
		if (question == '' || subject == '') {
			...
			.done(function() {
				...
				$('#asksub').val('');
				$('textarea#asktxt').val('');
				$('form').append('<center id="temp"><div class="alert alert-success" style="width: 40%;">Topic successfully created. Check it out <a href="http://www.mofire.site90.net/forum/category.php?id=' + cattop + '">here</a></div></center>');
			})
			.fail(function() {
				console.log("error");
			})
