        ...
        {  
            ...
            { 
                ...
                { 
                    ...
                    echo '<center><div class="alert alert-success" style="width: 40%;">You have successfully created <a href="http://www.mofire.site90.net/forum/topic.php?id='. $topicid . '">your new topic</a>.</div></center>';
                } 
            } 
        } 
    } 
